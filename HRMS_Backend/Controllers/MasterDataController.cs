...
namespace HRMS_Backend.Controllers
{
    ...
    public class MasterDataController : ControllerBase
    {
        ...
        public MasterDataController(IDepartmentService service, IDesignationService designationService, IGenderService genderService,IadminService adminService,  ILogger<MasterDataController> logger)
        {
            _service = service;
