...
namespace HRMS_Backend.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        public EmployeeController(IEmployeeResignationService resignationService, IemployeeService employeeService, ILeaveService leaveService, IWebHostEnvironment env)
        {
...
public class UpdateResignationStatusRequest
{
    ...
    public bool IsHRReject { get; set; }
        ...
        /// </summary>
        [HttpPut("UpdateempEmerAsync/{id}")]
        public async Task<IActionResult> UpdateempEmerAsync(int id, [FromBody] EmployeeEmergencyContactDto model)
        {
        ...
        /// </summary>
        [HttpDelete("DeleteempEmerAsync/{id}")]
        public async Task<IActionResult> DeleteempEmerAsync(int id)
        {
        ...
        /// </summary>
        [HttpPost("updateempRefAsync/{id}")]
        public async Task<IActionResult> updateempRefAsync(int id, [FromBody] EmployeeReferenceDto model)
        {
        ...
        /// </summary>
        [HttpPost("deleteempRefAsync/{id}")]
        public async Task<IActionResult> deleteempRefAsync(int id)
        {
